...
import { Menu, X, Trophy, Users, Calendar, Newspaper, BarChart3 } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Posiciones', path: '/tabla-de-posiciones', icon: BarChart3 },
  ];
